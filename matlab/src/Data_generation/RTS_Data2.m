...
%
%   This script is part of the data generation procees
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
system_info.cru = 0.2*system_info.c;    % cost of reserve up
system_info.crd = 0.2*system_info.c;    % cost of reserve down

% The cost of real time adjustment
system_info.cw = 0;     % windspill
system_info.cr = 2000;  % reserve increase
system_info.cl = 1000;  % loadshedding
...
% incorporate the conversion factor into the gas consumption
